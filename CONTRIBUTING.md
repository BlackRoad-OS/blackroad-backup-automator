# Contributing to blackroad-backup-automator
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-backup-automator.git
cd blackroad-backup-automator

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-backup-automator.git
